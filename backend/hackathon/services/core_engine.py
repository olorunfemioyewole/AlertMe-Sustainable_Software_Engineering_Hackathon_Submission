"""
SafeAlert Core Engine
Receives incident reports, runs confidence scoring, assigns dispatch tiers,
and writes everything to SQLite via SQLAlchemy async.
...
async def compute_score(incident: Incident, db: AsyncSession) -> dict:
    ...
    corroborating.add(incident.phone_or_user_id)
